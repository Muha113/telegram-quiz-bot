...
def update_stat(bot):
    ...
    for x in users:
        if x[mongodb.AvailableFields.STATUS_INGAME]:
            ...
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.RIGHT_ANSWERS, 0)
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.AVERAGE, new_average)
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.TOTAL_GAMES, total_games + 1)
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.TOTAL_RIGHT_ANSWERS, total_ans + right_ans)
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.QST_COUNT, 1)
            mongodb.update_db(x[mongodb.AvailableFields.ID], mongodb.AvailableFields.STATUS_INGAME, False)
